...
class _AdminPermissionsScreenState extends State<AdminPermissionsScreen>
  ...
  void initState() {
    ...
    context.read<AdminPermissionsCubit>().loadPermissions();
  ...
  void _onTabChanged() {
    ...
    context.read<AdminPermissionsCubit>().setStatusFilter(
  ...
  Future<void> _approve(
    ...
    final ok = await context.read<AdminPermissionsCubit>().approvePermission(
      permission.id,
    );
  ...
  void _showFiltersSheet(BuildContext context, AdminPermissionsState state) {
    showModalBottomSheet(
      ...
      builder: (_) => BlocProvider.value(
        value: context.read<AdminPermissionsCubit>(),
...
class _FiltersSheet extends StatefulWidget {
  final AdminPermissionsState state;
        ...
        children: [
          ...
          Row(
            children: [
              ...
              TextButton(
                onPressed: () {
                  context.read<AdminPermissionsCubit>().clearFilters();
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                context.read<AdminPermissionsCubit>().setDateFilter(
                  dateFrom: _dateFrom,
                  dateTo: _dateTo,
                );
                Navigator.pop(context);
