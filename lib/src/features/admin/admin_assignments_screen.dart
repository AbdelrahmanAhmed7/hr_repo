...
class _AdminAssignmentsScreenState extends State<AdminAssignmentsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<AdminAssignmentsCubit, AdminAssignmentsState>(
                ...
                if (state.isLoading && state.items.isEmpty)
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList.separated(
                      ...
                      itemBuilder: (context, index) => DepartmentAssignmentCard(
  ...
  Widget _buildHeader(AdminAssignmentsState state) {
    return Container(
