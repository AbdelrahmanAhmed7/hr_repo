...
class _AssignmentApi implements AssignmentApi {
  ...
  @override
  Future<AssignmentResponse> createAssignment(AssignmentRequest body) async {
  ...
  Future<List<AssignmentResponse>> getMyAssignments() async {
    ...
    final _options = _setStreamType<List<AssignmentResponse>>(
    ...
    late List<AssignmentResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                AssignmentResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
