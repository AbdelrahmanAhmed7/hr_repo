...
class _HomeApi implements HomeApi {
  ...
  Future<HomeApiResponse> getHomeData() async {
    ...
    final _options = _setStreamType<HomeApiResponse>(
    ...
    late HomeApiResponse _value;
    try {
      _value = HomeApiResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<List<HomeRequestItem>> getAllRequests({int? month}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<HomeRequestItem>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Home/viewall',
    ...
    late List<HomeRequestItem> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => HomeRequestItem.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
